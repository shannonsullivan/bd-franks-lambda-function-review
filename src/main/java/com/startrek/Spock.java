...
public class Spock implements RequestHandler<String, String> {
        /*
          Method to handle AWS Lambda requests
        */
        @Override
        //     return-type  method-name(object-with-request-data, aws-lambda-context-object)
        public String  handleRequest(String aLine,  Context context) {
                ...
                System.out.println("The needs of the many outweigh the needs of the few, or the one");
